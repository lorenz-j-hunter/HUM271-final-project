...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!localStorage.getItem('visibility_x')) {
    localStorage.setItem('visibility_x', 'content-visibility: hidden;');
  }
  document.querySelector('#csv').style = localStorage.getItem('visibility_x')
});
...
function activate() {
  ...
  localStorage.setItem('visibility_x', 'content-visibility: visible;');
}